...
2. пишет `build/optimizer_input.json`;
3. запускает `build/route_solver`;
4. читает `build/optimizer_output.json`;
5. возвращает маршрут frontend'у.
